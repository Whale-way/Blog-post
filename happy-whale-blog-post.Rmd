...
Before the modelling, we split our dataset into a training set (30.000 images), a val- idation set (10.826 images) and a test set (10.207 images).
...
```{r fig3, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Model architecture"}
