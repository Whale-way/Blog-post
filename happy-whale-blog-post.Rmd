...
###Evaluation
- thought we would only describe our evaluation metrics here
- just a short list of the chosen evaluation metrics (like the BERT thing)
- and then i just moved your paragraphgs into the results section
...
- include the results table of the DL model
