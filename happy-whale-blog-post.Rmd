...
```
 pictures of whale through time
...
what we have and maybe less techicnical, focus on the happy use case , intiatied compitetion  
...
proposed methods: inshert photo showing different graphs
...
**Classical Aproach**: Describe the evaluation metric(s) you used, plus any other details necessary to understand your evaluation. How you ran your experiments (e.g. model configurations, learning rate, training time, etc.) 

**Deep Learning Approach**: Describe the evaluation metric(s) you used, plus any other details necessary to understand your evaluation. How you ran your experiments (e.g. model configurations, learning rate, training time, etc.) 
