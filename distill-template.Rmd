...
Figure 8 below shows the loss score over time as we ran the graph as we searched for individuals over a span of 500 epochs. As you can see it does not change the outcome much after 450 epoch so for future research it would be recommended to switch to a B2 Efficientnet. 
